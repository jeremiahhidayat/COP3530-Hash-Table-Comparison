<H1> COP3530 - Project 2: Comparing Hash Tables </h1>
...
implementations are similar in functionality and function calling to make the rest of the implemenation streamlined.